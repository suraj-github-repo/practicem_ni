    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" >
			...
			<div class="panel-body" style="line-height: 35px;">
									<form class="row form-group" action="product_code.php" enctype="multipart/form-data" method="post">
										  <input type="hidden" name="$adminId"   value="<?php echo $adminId;?>" >
					
                                        <div class="col-lg-6 col-sm-12 col-md-6">
                                            <label class="control-label" >Product Name <span class="required">*</span></label>
											<input type="text" name="pname" placeholder="Enter product Name" style="text-transform: capitalize;"  value="" onkeypress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || (event.charCode==32)" class="form-control" required>
                                        </div>
                                        <div class="col-lg-6 col-sm-12 col-md-6">
                                            <label class="control-label">Product Price <span class="required">*</span></label>
											<input type="text" name="pprice" placeholder="Enter Product Price"  style="text-transform: capitalize;"  value="" class="form-control" required >
                                        </div>

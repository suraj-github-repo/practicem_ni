...
<html lang="en">
  ...
  <body style="background: rgb(233, 233, 233); font-family: Segoe UI light;">
    ...
    <div class="container-fluid">
      ...
      <form method="post" id="invoice_form" action="<?php $_SERVER['PHP_SELF']?>">
<!--          <?php var_dump($_REQUEST); ?>-->
            ...
            <tr>
               ...
               <!--         <input type="text" name="order_receiver_name" id="order_receiver_name" class="form-control input-sm" placeholder="Enter Receiver Name" /> -->
                       <?php 
					    ...
					    $sql = "SELECT  `first_name`,last_name FROM `tbl_candidate_registration`;";
                        $car_brands = mysqli_query ($con, $sql);

					    ?>
                     <select Brand Name='order_receiver_name' id="order_receiver_name" class="form-control input-sm">
                     <option value="">--- Select ---</option>
                      ...
                      while ($row = mysqli_fetch_array(
                       ...
                       ?>
                           <option value="<?php echo ($row['first_name'])." ".ucfirst($row['last_name']);
                       ?>">
                               <?php echo ($row['first_name'])." ".ucfirst($row['last_name']);?>
                           </option>
                      <?php
                            endwhile;
                      ?>
                    ...
                    <div class="col-md-4">
					  ...
					  <?php
                           $querycustomer="select order_id from inv_order order by order_id asc";
                           $result = $con->query($querycustomer);
	
	                        while($row = $result->fetch_assoc()) {
                            $customer = $row['order_id'] + 1 ;
		
                            }  ?>
                      <div class="form-group">
                      <input type="text" name="order_no" id="order_no" class="form-control input-sm number_only" maxlength="6" value="<?php echo $customer;?>" placeholder="Enter Invoice No." />
                      </div>
                  ...
                  <table id="invoice-item-table" class="table table-bordered table-hover table-striped">
                    ...
                    <tr>
                      ...
                      <td>
					    ...
					    ?>
                     <select Brand Name='item_name[]' id="item_name1" class="form-control input-sm">
                     <option value="">--- Select ---</option>
      ...
      $(document).ready(function(){
        ...
        html_code += '<td><input type="text" name="order_item_tax2_rate[]" id="order_item_tax2_rate'+count+'" data-srno="'+count+'" class="form-control input-sm number_only order_item_tax2_rate" /></td>';
         ...
         html_code += '<td><input type="text" name="order_item_tax3_amount[]" id="order_item_tax3_amount'+count+'" data-srno="'+count+'" readonly class="form-control input-sm order_item_tax3_amount" /></td>';
          ...
          html_code += '<td width="5%"><button type="button" name="remove_row" id="'+count+'" class="btn btn-danger btn-xs remove_row">X</button></td>';
          html_code += '</tr>';
    ...
    <br />
      ...
      <div align="LEFT">
	   <li>
                        <a class="btn btn-success" href="index.php"><i class="fa fa-dashboard"></i> Dashboard</a>
                    </li><!--/.navbar-collapse -->
        <div > 
		<div align="right">
